...
execute at @s if score @s vwf_wither_hp < tp_hp vwf_wither_hp unless score @s vwf_wither_hp matches 0 run teleport @s ~ ~-2 ~

execute at @s if score @s vwf_wither_hp < tp_hp vwf_wither_hp unless score @s vwf_wither_hp matches 0 run tag @s add tped